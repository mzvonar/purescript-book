...
import Graphics.Canvas (closePath, lineTo, moveTo, fillPath,
                        ...
                        getCanvasElementById, strokePath, setStrokeStyle)
import Math as Math
...
main = void $ unsafePartial do
  ...
  setStrokeStyle ctx "#b21"
    
  fillPath ctx $ strokePath ctx $ rect ctx $ translate (-200.0) (-200.0)
    { x: 250.0
    , y: 250.0
    , width: 100.0
    , height: 100.0
  ...
  fillPath ctx $ strokePath ctx $ arc ctx $ translate 200.0 200.0
    { x: 300.0
    , y: 300.0
    , radius: 50.0
    , start: 0.0
